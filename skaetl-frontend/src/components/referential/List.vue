     ...
     <v-data-table v-bind:headers="headers" :items="listReferential" hide-actions >
         <template slot="items" slot-scope="props">
           <td class="text-md-center">
                  ...
                  <v-btn color="error" style="width: 120px" small text-color="white" v-if="props.item.statusProcess == 'ENABLE'" v-on:click.native="deactivateReferential(props.item.id)">DeActivate<v-icon right>close</v-icon></v-btn>
